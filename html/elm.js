		...
		return metric ? A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('fa fa-square-o')
						]),
					_elm_lang$core$Native_List.fromArray(
						[])),
					_elm_lang$html$Html$text(
...
var _mdgriffith$elm_package_skimmer$Main$deprecationWarning = function (deprecated) {
	return deprecated ? A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('deprecation-warning')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('fa fa-exclamation')
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
...
var _mdgriffith$elm_package_skimmer$Main$packages = _elm_lang$core$Native_Platform.incomingPort(
	...
	A2(
		...
		A2(_elm_lang$core$Json_Decode_ops[':='], 'retrieved', _elm_lang$core$Json_Decode$string),
		function (retrieved) {
			return A2(
				_elm_lang$core$Json_Decode$andThen,
				A2(
					...
					_elm_lang$core$Json_Decode$list(
						A2(
							...
							function (name) {
								return A2(
									_elm_lang$core$Json_Decode$andThen,
									A2(_elm_lang$core$Json_Decode_ops[':='], 'deprecated', _elm_lang$core$Json_Decode$bool),
									function (deprecated) {
										return A2(
											_elm_lang$core$Json_Decode$andThen,
...
var _mdgriffith$elm_package_skimmer$Main$viewSidebar = _elm_lang$core$Native_List.fromArray(
	[
		A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('package standard-package-list')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Standard Packages')
							])),
						A2(
						_elm_lang$html$Html$ul,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('side-package-list')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
									...
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														_elm_lang$html$Html_Attributes$class('indent')
													]),
												_elm_lang$core$Native_List.fromArray(
													[
														A2(
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_mdgriffith$elm_package_skimmer$Main$cornerStone, 'logo-svg', _mdgriffith$elm_package_skimmer$Main$AllColors)
						])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('search-container')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('last-updated')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text(
								...
								return A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											_elm_lang$core$Native_List.fromArray(
												[
													_elm_lang$html$Html_Attributes$class('fa fa-legal')
												]),
											_elm_lang$core$Native_List.fromArray(
												[])),
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											A2(
												_elm_lang$core$Basics_ops['++'],
												' ',
												A2(_elm_lang$core$Basics_ops['++'], _p6._0, ' license')))
										]));
							}
						}(),
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _mdgriffith$elm_package_skimmer$Main$main === 'undefined' ? null : _mdgriffith$elm_package_skimmer$Main$main);
